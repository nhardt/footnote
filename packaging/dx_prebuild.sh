...
cp ./packaging/file_paths.xml ./target/dx/footnote/release/android/app/app/src/main/res/xml/
mkdir -p ./target/dx/footnote/debug/android/app/app/src/main/res/xml
cp ./packaging/file_paths.xml ./target/dx/footnote/debug/android/app/app/src/main/res/xml/

...
GRADLE_FILE="../../target/dx/footnote-ui/release/android/app/app/build.gradle.kts"
...
cd ../../target/dx/footnote-ui/release/android/app
./gradlew bundleRelease
cd -

OUTPUT_DIR="../../target/dx/footnote-ui/release/android/app/app/build/outputs/bundle/release/"
OUTPUT_FILE="${OUTPUT_DIR}/Footnote-${VERSION}.aab"
cp ../../target/dx/footnote-ui/release/android/app/app/build/outputs/bundle/release/app-release.aab \
    $OUTPUT_FILE
